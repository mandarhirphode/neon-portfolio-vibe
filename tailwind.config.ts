  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(142 100% 50% / 0.5), 0 0 40px hsl(142 100% 50% / 0.3)" },
          "50%": { boxShadow: "0 0 30px hsl(142 100% 50% / 0.8), 0 0 60px hsl(142 100% 50% / 0.5)" },
        },
        "text-flicker": {
          "0%, 100%": { opacity: "1", textShadow: "0 0 10px hsl(142 100% 50%), 0 0 20px hsl(142 100% 50% / 0.5)" },
          "50%": { opacity: "0.92", textShadow: "0 0 6px hsl(142 100% 50%), 0 0 14px hsl(142 100% 50% / 0.4)" },
        },
